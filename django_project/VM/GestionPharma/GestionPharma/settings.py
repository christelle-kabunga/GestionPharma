...
SECRET_KEY = 'django-insecure-xkdieiu!v8!y4yap!0g=%k-b2aphi!2mzi(3fw^7n!)rs7w%*+'
...
ROOT_URLCONF = 'GestionPharma.urls'
...
WSGI_APPLICATION = 'GestionPharma.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gestionphare',  # Vérifie que c'est bien le bon nom
